...
import type { BlogArticle as _BlogArticle } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    constructor(private actor: ActorSubclass<_SERVICE>, private _uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, private _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, private processError?: (error: unknown) => never){}
    async addBlogArticle(arg0: string, arg1: string, arg2: string, arg3: string, arg4: Array<string>, arg5: Timestamp, arg6: string, arg7: string): Promise<ArticleId> {
    ...
    async getBlogArticleById(arg0: ArticleId): Promise<BlogArticle | null> {
        if (this.processError) {
            try {
    ...
    async getBlogArticles(): Promise<Array<BlogArticle>> {
        if (this.processError) {
            try {
    ...
    async searchBlogArticles(arg0: string, arg1: string | null, arg2: string | null): Promise<Array<BlogArticle>> {
        if (this.processError) {
            try {
    ...
    async submitContact(arg0: string, arg1: string, arg2: ServiceType, arg3: string): Promise<bigint> {
        if (this.processError) {
            try {
...
function from_candid_opt_n1(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_BlogArticle]): BlogArticle | null {
