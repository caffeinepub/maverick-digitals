import { c as createLucideIcon, r as reactExports, j as jsxRuntimeExports, e as createSlot$1, b as cn, f as composeRefs, o, u as useComposedRefs, g as reactDomExports, R as React, v as vt, M as Mail, P as Phone, h as MapPin, I as Instagram, a as Linkedin, T as Twitter, B as Button } from "./index-SL9QaX1w.js";
import { I as Input } from "./input-Dxs48-d7.js";
import { C as ChevronDown, S as Send } from "./send-Bm0fMKTK.js";
import { u as useRevealOnScroll } from "./useIntersectionObserver-bDJPKJVW.js";
import { b as useSubmitContact } from "./useQueries-DiEoye8A.js";
...
function Contact() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setSubmitted(true);
      ue.success("Message sent! We'll be in touch within 48 hours.");
    } catch {
      ue.error("Something went wrong. Please try again.");
    }
  };
  const fieldClass = (field) => `bg-muted/30 border transition-all duration-300 focus:ring-0 h-11 ${touched[field] && errors[field] ? "border-destructive/70 focus:border-destructive" : "border-border focus:border-primary/60 focus:shadow-[0_0_0_3px_oklch(var(--primary)/0.12)]"}`;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative pt-24 pb-24 min-h-screen overflow-hidden", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(ParticleField, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 grid-glow-bg opacity-25 pointer-events-none" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-1/4 left-1/5 w-96 h-96 bg-primary/8 rounded-full blur-[130px] pointer-events-none" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute bottom-1/3 right-1/5 w-72 h-72 bg-secondary/8 rounded-full blur-[110px] pointer-events-none" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-2/3 left-1/2 w-48 h-48 bg-accent/6 rounded-full blur-[90px] pointer-events-none" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative max-w-7xl mx-auto px-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-primary text-xs font-semibold uppercase tracking-widest mb-4 inline-flex items-center gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-1.5 h-1.5 rounded-full bg-primary animate-pulse" }),
              "Get In Touch"
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "font-display font-bold text-5xl md:text-6xl lg:text-7xl text-foreground leading-tight mb-5", children: [
              "Let's Build Something",
              " ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gradient-text-purple", children: "Remarkable" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-lg leading-relaxed", children: "Whether you're starting fresh or scaling an existing brand — we map out a custom path to measurable growth." })
          ]
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          ...
          children: STATS.map(({ value, label, icon: Icon2 }) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-bold text-2xl gradient-text-purple leading-none mb-1", children: value }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-xs leading-tight", children: label })
              ]
            },
            label
          ))
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-5 gap-8 xl:gap-12", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ref: leftRef,
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glassmorphic border-primary/20 p-6 relative overflow-hidden", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gradient-to-br from-primary/8 via-transparent to-accent/5 rounded-lg pointer-events-none" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-semibold text-primary uppercase tracking-widest mb-3", children: "Maverick Digitals" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-display font-bold text-xl text-foreground mb-2 leading-tight", children: [
                    "Your Growth Partner,",
                    /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
                    "Not Just an Agency."
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground leading-relaxed", children: "We don't just run campaigns — we architect entire growth systems built around your unique brand DNA." })
                ] })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "glassmorphic border-white/8 p-5 space-y-3", children: [
                {
                  icon: Mail,
                  label: "Email",
              ...
              ].map(({ icon: Icon2, label, value, href }) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4 group", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-9 h-9 rounded-xl bg-primary/10 border border-primary/20 flex items-center justify-center shrink-0 group-hover:bg-primary/20 transition-smooth", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon2, { size: 15, className: "text-primary" }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground uppercase tracking-wider leading-none mb-0.5", children: label }),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glassmorphic border-white/8 p-5", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground uppercase tracking-widest mb-3", children: "Why Maverick?" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-2.5", children: [
                  ...
                  "li",
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-1.5 h-1.5 rounded-full gradient-neon-purple shrink-0" }),
                      item
                    ]
                  },
                  item
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glassmorphic border-white/8 p-5", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground uppercase tracking-widest mb-4", children: "Follow Us" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-3", children: SOCIAL_LINKS.map(({ icon: Icon2, label, href, color }) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "a",
                  {
                    href,
                    "aria-label": label,
          ...
          "div",
          {
            ...
            children: submitted ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gradient-to-br from-primary/8 via-transparent to-accent/5 pointer-events-none rounded-lg" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative flex flex-col items-center", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative mb-8", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-24 h-24 rounded-full gradient-neon-purple glow-neon flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheckBig, { size: 44, className: "text-background" }) }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute -inset-3 rounded-full border border-primary/20 animate-ping" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "div",
                        {
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-bold text-3xl text-foreground mb-3", children: "Message Received!" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-muted-foreground leading-relaxed max-w-sm mb-2", children: [
                      "Thank you for reaching out. Our team will review your project details and get back to you with a tailored strategy within",
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-muted-foreground/60 text-sm mb-8", children: [
                      "Check your inbox at",
                      " ",
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-foreground/80", children: form.email })
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "button",
                      {
              ...
              "form",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-0 right-0 w-64 h-64 bg-primary/5 rounded-full blur-[80px] pointer-events-none" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute bottom-0 left-0 w-48 h-48 bg-accent/5 rounded-full blur-[60px] pointer-events-none" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-semibold text-primary uppercase tracking-widest mb-1", children: "Start a Conversation" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-bold text-2xl text-foreground", children: "Tell Us About Your Goals" })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-5 relative", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
                      ...
                      touched.name && errors.name && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-destructive text-xs mt-1", children: errors.name })
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsxs(
                        Label,
                      ...
                      touched.email && errors.email && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-destructive text-xs mt-1", children: errors.email })
                    ] })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5 relative", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      Label,
                      {
                        htmlFor: "service",
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      Select,
                      {
                        ...
                        onValueChange: (v2) => {
                          setForm({ ...form, serviceType: v2 });
                          setTouched((t) => ({ ...t, serviceType: true }));
                          setErrors((er) => ({ ...er, serviceType: void 0 }));
                        },
                        children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx(
                            SelectTrigger,
                            {
                              className: `h-11 bg-muted/30 border transition-all duration-300 ${touched.serviceType && errors.serviceType ? "border-destructive/70" : "border-border focus:border-primary/60"}`,
                              "data-ocid": "contact-select-service",
                              children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectValue, { placeholder: "Choose a service..." })
                            }
                          ),
                          /* @__PURE__ */ jsxRuntimeExports.jsx(SelectContent, { className: "glassmorphic-dark border-white/12 z-50", children: SERVICE_TYPES.map((s) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                            SelectItem,
                            {
                              value: s,
                    ...
                    touched.serviceType && errors.serviceType && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-destructive text-xs mt-1", children: errors.serviceType })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5 relative", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      Label,
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
                      touched.message && errors.message ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-destructive text-xs", children: errors.message }) : /* @__PURE__ */ jsxRuntimeExports.jsx("span", {}),
                      /* @__PURE__ */ jsxRuntimeExports.jsxs(
                        "span",
                        {
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    Button,
                    {
                      ...
                      children: isPending ? /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-2.5", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-4 h-4 rounded-full border-2 border-background/30 border-t-background animate-spin" }),
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-center text-muted-foreground/50 text-xs", children: "No spam, ever. We respect your privacy and respond within 48 hours." })
                ]
              }
            )
          }
